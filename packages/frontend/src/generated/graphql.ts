...
export type GetUserByCustomIdQuery = {
  __typename?: 'query_root'
  users: Array<{
    __typename?: 'users'
    name?: string | null
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    GetUserByCustomId(
      ...
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<GetUserByCustomIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUserByCustomIdQuery>(GetUserByCustomIdDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'GetUserByCustomId',
    ...
    getUserByUid(
      variables: GetUserByUidQueryVariables,
      requestHeaders?: Dom.RequestInit['headers'],
    ): Promise<GetUserByUidQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetUserByUidQuery>(GetUserByUidDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'getUserByUid',
